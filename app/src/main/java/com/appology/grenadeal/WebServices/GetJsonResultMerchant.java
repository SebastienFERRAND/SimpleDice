...
//TODO refactoring
public class GetJsonResultMerchant extends AsyncTask<String, String, JSONObject>

{
    ...
    private List<GetJsonListenerMerchant> listeners = new ArrayList<>();
    ...
    protected void onPostExecute(JSONObject jsonP) {
        ...
        try {
            ...
            json = jsonP;
            for (GetJsonListenerMerchant hl : listeners) {
                hl.getReturnMerchant();
            }
        } catch (Exception e) {
            e.getMessage();
        }
    ...
    public void addListener(GetJsonListenerMerchant toAdd) {
        listeners.add(toAdd);
    }
